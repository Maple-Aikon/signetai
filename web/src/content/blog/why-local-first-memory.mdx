...
**Fast** — SQLite queries are sub-millisecond. No network round trip. No API rate limit. Your agent's recall is as fast as your disk.

**Private** — Your memories never leave your machine unless you explicitly set up git sync to your own remote. Even then, it's your repo, your server, your encryption.
