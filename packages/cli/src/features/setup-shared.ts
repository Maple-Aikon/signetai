...
export type HarnessChoice = "claude-code" | "opencode" | "openclaw" | "oh-my-pi" | "pi" | "codex" | "forge" | "hermes-agent" | "gemini";
...
export function formatDetectionSummary(detection: SetupDetection): string {
	...
	if (detection.harnesses.gemini) harnesses.push("Gemini CLI");
