<script lang="ts">
	...
	/* ── Widget preview is deferred to zoom view ──────────
	 * Loading 16 × 227KB srcdoc iframes on the grid was crashing the browser.
	 * The grid now shows the lightweight terminal-style preview for ALL agents.
	 * Widget iframe only renders in the ZoomView / ActivityPanel when you click in.
	 * ──────────────────────────────────────────────────── */
	...
	/* Widget previews are handled in ZoomView/ActivityPanel on click */
